...
vetex=[1 710 710 1 1;135 135 209 209 135];
% % arrow=zeros(710,355);
% % arrow(:,154:202)=1;
...
row_res=round(1:(4*11.27):710); 
col_res=round(1:(2.0*6.09):355);
...
for i=1:length(theta)
    ...
    vetex_rot(1,:)=(vetex_rot(1,:)-1)/4/11.27+1;
    vetex_rot(2,:)=(vetex_rot(2,:)-1)/2/6.09+1;
    a=img_temp(:,:,i);
    counter=counter+1;
    img_pca(:,counter)=a(:);
    log_a(counter)=sum(a(:));
