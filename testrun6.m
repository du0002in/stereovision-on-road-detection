...
leftimg_dir='D:\Stereo\Image Collection(new Cam)9\left';
rightimg_dir='D:\Stereo\Image Collection(new Cam)9\right';
save_dir='D:\Stereo\Image Collection(new Cam)9';
...
log_ite_s=[25 1 1 1 55 25]; 
log_ite_e=[160  120 100 2040 307 200];
