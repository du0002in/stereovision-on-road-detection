...
arrow_gt=[5,6,7,8,9,10,46,47,48,49,50,51,64,65,66,67, ...
    ...
    763:768, 793:798, 812:816, 842:845, 855:857];
letter_gt=[15,16,17,18,19,66,67,68,69,70,71,72, ...
    ...
    766,767,768,769,770,817,818,819];
...
% % %     if (ii>=3) && abs(log_Estimate_d_theta(ii)-log_Estimate_d_theta(ii-1))>0.07
% % %         log_Estimate_d_theta(ii)=median(log_Estimate_d_theta((ii-2):ii));
% % %     end
